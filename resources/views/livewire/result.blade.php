<div>
    ...
    <button wire:click="question1" class="btn btn-dark btn-sm ">Show Arg</button>
...
<br>
<br>
    <button wire:click="question2" class="btn btn-dark btn-sm">Parcelle</button>
...
<br>
<br>
    <button wire:click="question3" class="btn btn-dark btn-sm">ParcelleInfo</button>
...
<br>
    ...
    <button wire:click="question4" class="btn btn-dark btn-sm">ParcelleAgr</button>
...
<br>
<br>
    <button wire:click="question5" class="btn btn-dark btn-sm">Intervention</button>
    ...
    @endif
    <br><br><br>
    <button wire:click="question6" class="btn btn-dark btn-sm">InterPar</button>
...
<br>
<br>
    <button wire:click="question7" class="btn btn-dark btn-sm">InterParEmp</button>
...
<br>
<br>
    <button wire:click="question8" class="btn btn-dark btn-sm">InterEmp</button>
...
<br>
<br>
    <button wire:click="question9" class="btn btn-dark btn-sm">countpar</button>
